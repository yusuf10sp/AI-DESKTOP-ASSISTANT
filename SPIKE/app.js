...
recognition.onresult = function (event) {
  ...
  if (transcript.includes("hello friday")) {
    readOut("hello sir, how can i be of service")
  ...
  if (transcript.includes("open my github profile")) {
    ...
    let a = window.open("https://github.com/yusuf10sp/");
    windowsB.push(a);
  }
  if (transcript.includes("open weather report")) {
    readOut("opening weather report sir");
    let a = window.open("https://www.accuweather.com//");
    windowsB.push(a);
  }
  ...
  if (transcript.includes("open my linkedin profile")) {
    ...
    let a = window.open("https://www.linkedin.com/in/md-yusuf-6192a7271/");
    windowsB.push(a);
  }
